...
// // SETS
// // REMOVES THE DUPLIATES

// // const orderSet = new Set(["pasta", "pasta", "pizza", "pizza", "burger"]);

// // console.log(orderSet);

// // console.log(new Set("Spider"));
...
// // // AS WE ALREADY KNOW ...SpreadOperator unpacks elements from iterablls to separate elemnents
...
// // restaurantMap.set("name", "THE KING LAND");
// // restaurantMap.set(1, "NewYork, US");
// // console.log(restaurantMap.set(2, "Flordia, US"));

// // restaurantMap
// //   .set("Tagline", "Experience the Worlds Most Beautiful Place")
// //   .set("open", ["mon", "tue", "wed", "thu", "fri", "sat"]);
...
// //   ["question", "what is the best programmong language in the world?"],
// //   [1, "c"],
// //   [2, "JAVA"],
// //   [3, " JavaScript"],
// //   ["correct", 3],
...
const plane = "Boeing320";
console.log(plane[0]);
console.log("Spidey"[0]);
...
// comaparing emails
const email = "helloto@world.io";
const givenEmail = "   Helloto@WORLD.io \n";

const lowerEmail = givenEmail.toLowerCase();
const trimEmail = lowerEmail.trim();
console.log(trimEmail);

email === trimEmail ? console.log("correct") : console.log("wrong");
// replacing string
const priceUS = "1449$";
...
const announcement = `All Passangers come to door to 23`;

console.log(announcement.replace("door", "gate"));

// Booleans

const planeNew = "A40neo";
console.log(planeNew.includes("A40"));
console.log(planeNew.startsWith("A"));
console.log(planeNew.endsWith("h"));

// split Method
// it splits the given String with given condition and creates a array and put them in it
console.log("a+ very + nice + string".split("+"));
const [fristName, latName] = "Spider Man".split(" ");

const result = ["Mr.", fristName, latName.toUpperCase()].join(" ");

console.log(result);

// padding a string
const message = "Avnegers Assemble";
console.log(message.padStart(25, "+"));
console.log(message.padEnd(25, "-"));
// eg

const masking = function (num) {
  const str = num + "";
  const last = str.slice(-4);
  return last.padStart(str.length, "*");
};

console.log(masking(123456789876));

// repeat method

const repeatMessage = "Bad Weather Avoid going outside * ";

console.log(repeatMessage.repeat(5));

const planeinLine = function (n) {
  console.log(`There are ${n} number of planes waiting in queue`.repeat(n));
};
